...
We can also use ANOVA for our nested model comparison, and we can observe a high
p-value thus suggesting that the interaction model may be a more insignificant 
